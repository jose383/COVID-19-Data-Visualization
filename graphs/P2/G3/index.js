...
var labels = ['0', '1 - 999', '1,000 - 9,999', '10,000 - 99,999', '100,000 - 749,999', '750,000 - 1.9M', '> 2M'];
...
d3.queue()
    ...
    .defer(d3.csv, "../../../data/Common/P2G1-3.csv", function(d) { data.set(d.code, +d.Recovered); })
    .await(ready);
